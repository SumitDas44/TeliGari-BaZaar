...
// Store the car data in an array
$cars = array();
...
<!-- HTML code to display the car data -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<header class="header">
    ...
    <h1>Explore your Favourite cars</h1>
    <div class="car-container">
    <?php foreach ($cars as $car): ?>
        <div class="cars">
            <div class="segment"><img src="images/<?php echo $car['image']; ?>" alt=""></div>
            <div class="segment">
                <div class="content">
                    <h3><?php echo $car['model']; ?></h3>
                    <p><?php echo $car['make']; ?></p>
                    <h2><?php echo $car['year']; ?></h2>
                </div>
            </div>
            <div class="segment">
                <p>Features:</p>
                <ul class="grid-list">
                    <li><?php echo $car['feature1']; ?></li>
                    <li><?php echo $car['feature2']; ?></li>
                    <li><?php echo $car['feature3']; ?></li>
                </ul>
            </div>
            <div class="segment">
