        ...
        <div class="fuels">
            <div class="content">
               ...
               <form action="" method="post">
                ...
                <input type="hidden" name="product_image" value="<?php echo $fuel['image']; ?>">
                <input type="hidden" name="product_name" value="<?php echo $fuel['name']; ?>">
                <input type="hidden" name="product_price" value="<?php echo $fuel['price']; ?>">
