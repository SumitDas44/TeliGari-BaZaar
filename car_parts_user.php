...
<header class="header">
    ...
    <h1>Everything you need all at once!</h1>
    <div class="car-container">
    <?php foreach ($parts as $part): ?>
        <div class="cars">
            <div class="segment"><img src="images/<?php echo $part['image']; ?>" alt=""></div>
            <div class="segment">
                <div class="content">
                    <h3><?php echo $part['name']; ?></h3>
                    <h2><?php echo $part['state']; ?></h2>
                </div>
            </div>
            <div class="segment">
                <p>Details:</p>
                <ul class="grid-list">
                    <li><?php echo $part['details']; ?></li>
                </ul>
            </div>
            <div class="segment">
                ...
                <input type="hidden" name="product_image" value="<?php echo $part['image']; ?>">
                <input type="hidden" name="product_name" value="<?php echo $part['name']; ?>">
                <input type="hidden" name="product_price" value="<?php echo $part['price']; ?>">
