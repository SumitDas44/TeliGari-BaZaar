...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO battery(name, capacity, price, details, image) VALUES('$name','$capacity','$price','$details','$image')";
...
<header class="header">
    ...
    <h1>Add More Batteries!</h1>
    <div class="add-container">
        <form action="" method="POST">
        <input type="text" name="name" required placeholder="Enter Battery Manufacturer name">
        <input type="text" name="capacity" required placeholder="Capacity of the battery (Ex: 45 Amps. 12 Volts)">
        <input type="text" name="price" required placeholder="Price (Ex: $125)">
        <input type="text" name="details" required placeholder="Product details">
        <input type="text" name="image" required placeholder="Fuel image (Ex: battery-10.png)"><br>
