...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO car_parts(name, state, price, details, image) VALUES('$name','$state','$price','$details','$image')";
...
<header class="header">
    ...
    <div class="add-container">
        ...
        <input type="text" name="name" required placeholder="Enter Car-part name">
        <input type="text" name="state" required placeholder="Condition of the product">
        <input type="text" name="price" required placeholder="Price (Ex: $100 - $10k)">
        <input type="text" name="details" required placeholder="Parts details">
        <input type="text" name="image" required placeholder="Car-part image (Ex: parts-10.png)"><br>
