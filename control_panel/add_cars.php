...
if(isset($_POST['submit'])){
    ...
    $feature1 = mysqli_real_escape_string($conn, $_POST['feature1']);
    $feature2 = mysqli_real_escape_string($conn, $_POST['feature2']);
    $feature3 = mysqli_real_escape_string($conn, $_POST['feature3']);
    $image = mysqli_real_escape_string($conn, $_POST['image']);

    $insert = "INSERT INTO cars(make, model, year, price, feature1, feature2, feature3, image) VALUES('$make','$model','$year','$price','$feature1','$feature2','$feature3','$image')";
...
<header class="header">
    ...
    <div class="add-container">
        ...
        <input type="text" name="make" required placeholder="Enter Car Manufacturer name">
        <input type="text" name="model" required placeholder="Name of the Model">
        <input type="text" name="year" required placeholder="Year of release">
        <input type="text" name="price" required placeholder="Price (Ex: $44,480)">
        <input type="text" name="feature1" required placeholder="Car Features">
        <input type="text" name="feature2" required placeholder="Car Features">
        <input type="text" name="feature3" required placeholder="Car Features">
        <input type="text" name="image" required placeholder="Car image (Ex: car-22.png)"><br>
