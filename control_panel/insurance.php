...
// Store the insurance data in an array
$insurance = array();
...
<header class="header">
    ...
    <div class="show-container">
        <table>
            ...
            <tr class="insurance">
                <td><?php echo $ins['fname']; ?></td>
                <td><?php echo $ins['lname']; ?></td>
                <td><?php echo $ins['dob']; ?></td>
                <td><?php echo $ins['address']; ?></td>
                <td><?php echo $ins['email']; ?></td>
                <td><?php echo $ins['accident']; ?></td>
                <td><?php echo $ins['phone']; ?></td>
                <td><?php echo $ins['vin']; ?></td>
                <td><?php echo $ins['driver']; ?></td>
                <td><?php echo $ins['car']; ?></td>
                <td><?php echo $ins['coverage_expiration']; ?></td>
                <td><?php echo $ins['to_be_paid']; ?></td>
            </tr>
            <?php endforeach; ?>
        </table>
    </div>
