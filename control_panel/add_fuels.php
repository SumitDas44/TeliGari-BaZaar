...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO fuel(name, compatibility, price, details, image) VALUES('$name','$compatibility','$price','$details','$image')";
...
<header class="header">
    ...
    <div class="add-container">
        ...
        <input type="text" name="name" required placeholder="Enter fuel Manufacturer name">
        <input type="text" name="compatibility" required placeholder="Compatibility of the product">
        <input type="text" name="price" required placeholder="Price (Ex: $25.25/Litre)">
        <input type="text" name="details" required placeholder="Product details">
        <input type="text" name="image" required placeholder="Fuel image (Ex: fuel-07.png)"><br>
